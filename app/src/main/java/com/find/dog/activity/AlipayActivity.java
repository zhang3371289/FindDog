...
import com.find.dog.alipayUtil.AuthResult;
import com.find.dog.alipayUtil.OrderInfoUtil2_0;
import com.find.dog.alipayUtil.PayResult;
...
public class AlipayActivity extends FragmentActivity {
	...
	public void h5Pay(View v) {
		...
		/**
		 * url 是要测试的网站，在 Demo App 中会使用 AlipayH5Activity 内的 WebView 打开。
		 *
		 ...
		 * 进行测试。
		 * 
		 * AlipayH5Activity 中的 MyWebViewClient.shouldOverrideUrlLoading() 实现了拦截 URL 唤起支付宝，
